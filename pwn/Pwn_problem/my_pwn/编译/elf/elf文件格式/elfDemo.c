...
re GF_2_hex_cal(char op, char *hex_s1, char *hex_s2, char *hex_modstr);
char *GF_2_hex_Fp(char *hex_b, char *dec_p, char *hex_modstr);
gcd_re GF_2_exEuclid(char *binary_s1, char *binary_s2, char *modstr);
gcd_re GF_2_hex_exEuclid(char *hex_s1, char *hex_s2, char *hex_modstr);
...
//    char s1[LEN], s2[LEN];
//    scanf("%s%s",s1,s2);
//    gcd_re re = gcdext(s1, s2);
//    printf("%s %s %s",re.x, re.y, re.gcd);
...
gcd_re GF_2_hex_exEuclid(char *hex_s1, char *hex_s2, char *hex_modstr)
{
    ...
    gcd_re result = GF_2_exEuclid(bin_s1, bin_s2, bin_modstr);
